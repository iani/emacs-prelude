...
- ElDoc :: Show arguments required by current function in minibuffeer.
...
*** bookmark+, ido-mode, imenu(+), yasnippets (yas-global-mode), icicles
...
*** ElDoc: Show arguments for emacs-lisp function in minibuffer
