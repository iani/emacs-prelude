...
Note: Tidying and simplification started on: [2016-01-22 Fri]
...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'org-mode-hook
            (lambda ()
              ...
              (local-set-key (kbd "C-x C-c S") 'org-show-subtree)))
...
*** Class and Project notes, otags, diary
:PROPERTIES:
...
:PROPERTIES:
:ID:       F6F05606-5D98-4DA9-9343-BB78137E7901
:eval-id:  2
:END:
