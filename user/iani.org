...
** DISABLED [#B] Use replace-colorthemes for large selection of themes, Emacs 24-style
...
Hack for changing font size globally, for presentations.  This affects also the font size of the status bar and temporary windows like icicles etc.
